...
class BinaryIoU(IoU):
  ...
  Note, if a `threshold = 0` is provided, this class is the same as `IoU`.
  ...
  Args:
    target_class_ids: A tuple or list of target class ids for which the metric
      is returned. Options are `[0]`, `[1]`, or `[0, 1]`. For `[0]` or `[1]`,
      the IoU metric for class 0 or class 1, respectively, is returned. For
